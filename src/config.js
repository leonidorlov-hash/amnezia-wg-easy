...
// Optional IPv6 ULA prefix for the tunnel, e.g. WG_DEFAULT_ADDRESS6=fdcc:ad94:bacf:61a4::x
// The 'x' placeholder is replaced by the client number (1 = server).
module.exports.WG_DEFAULT_ADDRESS6 = process.env.WG_DEFAULT_ADDRESS6 || null;
...
${module.exports.WG_DEFAULT_ADDRESS6 ? `ip6tables -t nat -A POSTROUTING -s ${module.exports.WG_DEFAULT_ADDRESS6.replace('x', '')}/64 -o ${module.exports.WG_DEVICE} -j MASQUERADE;
...
${module.exports.WG_DEFAULT_ADDRESS6 ? `ip6tables -t nat -D POSTROUTING -s ${module.exports.WG_DEFAULT_ADDRESS6.replace('x', '')}/64 -o ${module.exports.WG_DEVICE} -j MASQUERADE;
